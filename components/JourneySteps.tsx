...
export const JourneyCard: React.FC<{ item: JourneyCardData }> = ({ item }) => (
    <div className="w-[320px] md:w-[420px] glass-card rounded-[2rem] p-6 border border-white/10">
        <div className="w-16 h-16 rounded-2xl bg-blue-500/10 flex items-center justify-center text-blue-400 mb-8">
        ...
        <div className="space-y-4">
            ...
            <p className="text-lg font-semibold text-slate-300">{item.subtitle}</p>
